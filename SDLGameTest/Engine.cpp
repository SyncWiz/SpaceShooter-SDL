...
void Engine::SetupMainGameScene()
{
    ...
    m_SpaceScene->AddEntity<Enemy>(ENEMY_SHIP_EXPLOSION_PATH, ENEMY_LIFE_POINTS, ENEMY_COLLIDER_SIZE, ENEMY_COLLIDER_SIZE, 0, ENEMY_SHIP_PATH, fPoint(PLAYER_SCALE, PLAYER_SCALE), iPoint(PLAYER_INITIAL_POSITION_X, PLAYER_INITIAL_POSITION_Y * 4), m_SpaceScene);
