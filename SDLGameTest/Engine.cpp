...
void Engine::SetupMainGameScene()
{
    ...
    m_SpaceScene->AddEntity<Asteroid>(ENEMY_SHIP_EXPLOSION_PATH, MathUtils::GetRandomInRange(2, 8), 10, 180, 180, 0, "Assets/Aestroids/aestroid_brown.png", fPoint(0.4f, 0.4f), iPoint(300, PLAYER_INITIAL_POSITION_Y * 13), m_SpaceScene);
